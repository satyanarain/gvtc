...
<h1>@lang('menu.manage', array(),Session::get('language_val')) @lang('menu.growth_form', array(),Session::get('language_val'))</h1>
...
<a href="<?= $urls ?>" class="btn btn-success visible-lg-block visible-md-block ">
    {{ title_case(str_replace('growth','Growth Form',(Request::segment($i)))) }}
</a> 
<?php } ?>
@else 
<?php 
