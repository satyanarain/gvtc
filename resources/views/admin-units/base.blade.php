...
<h1>@lang('menu.manage', array(),Session::get('language_val')) @lang('menu.admin_unit', array(),Session::get('language_val'))</h1>
...
<a href="<?= $urls ?>" class="btn btn-success visible-lg-block visible-md-block ">
   {{ title_case(str_replace('admin-unit','Admin Unit',(Request::segment($i)))) }}
</a> 
<?php } ?>
@else 
<?php 
