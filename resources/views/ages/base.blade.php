...
<h1>@lang('menu.manage', array(),Session::get('language_val')) @lang('menu.age_group', array(),Session::get('language_val'))</h1>
...
<a href="<?= $urls ?>" class="btn btn-success visible-lg-block visible-md-block ">
     {{ title_case(str_replace('age','Age Group',(Request::segment($i)))) }}
</a> 
<?php } ?>
@else 
<?php 
