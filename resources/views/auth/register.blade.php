        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('guest_register.create') }}">
                        {{ csrf_field() }}
                         ...
                         <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }} required">
                            <label for="first_name" class="col-md-4 control-label">User Name</label>
                        ...
                        <div class="form-group required" >
                         <label for="name" class="col-md-4 control-label">Account for Personal or Institutional Use</label>    
                        <div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('institution_type') ? ' has-error' : '' }} ">
                            ...
                            <div class="col-md-6">
                                <input id="institution_type" type="text" class="form-control" name="institution_type" value="{{ old('institution_type') }}"  autofocus>
