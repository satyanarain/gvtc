...
<a href="<?= $urls ?>" class="btn btn-success  visible-lg-block visible-md-block nter_none_<?php echo $count; ?>">{{ucfirst(Request::segment($i))}}</a> 
@else <div class="btn btn-primary btn-success">{{ucfirst(Request::segment($i))}}</div>
@endif 
<?php $count++; ?>
@endfor
</div>
