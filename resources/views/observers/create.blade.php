              ...
              <div class="box-body">
                <input type="hidden" name="observer_id"  value="{{ 'GVTCOBS'.$last_observeid }}" required  class="observer_id form-control" id="observer_id" placeholder="Observer ID">
                 ...
                 @if ($errors->has('institution'))
                  ...
                  <input type="textarea" name="last_name" value="{{ old('last_name') }}" required   class="form-control" id="last_name" placeholder="@lang('menu.last_name', array(),Session::get('language_val'))">
