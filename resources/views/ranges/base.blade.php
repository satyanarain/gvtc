...
<h1>@lang('menu.manage', array(),Session::get('language_val')) @lang('menu.range', array(),Session::get('language_val')) @lang('menu.codes', array(),Session::get('language_val'))</h1>
...
if(is_numeric(Request::segment($i))){ 
     ...
     $title = str_replace('ranges','Range',(Request::segment($i)));  
?> 
