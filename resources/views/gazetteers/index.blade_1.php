...
<?php if($getpermissionstatus!=0){?>
<a href="{{ route('gazetteer.edit', $gazetteers->id) }}" class="btn btn-bitbucket mini blue-stripe" style="margin-left: 15px;"  data-placement="top" data-toggle="tooltip" data-original-title="Edit">
