...
class Gazetteer extends Authenticatable
{
 ...
 'gazeteer_id','country_id','place','details','eastings','northings','zone','datum','longitude','latitude','day','month','year','habitat','altitude','slope','aspect' ,'soil' ,'protected_area_id','adminunit_id','remarks'     
