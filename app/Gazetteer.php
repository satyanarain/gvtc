...
class Gazetteer extends Authenticatable
{
  ...
  'countrie_id','place','details','eastings','northings','zone','datum','longitude','latitude','day','month','year','habitat','altitude','slope','aspect' ,'soil' ,'protected_area_id','adminunit_id','remarks'     
